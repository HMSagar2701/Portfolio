          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                skills: ["Java", "Golang", "JavaScript", "TypeScript", "Bash/Shell", "Python"],
              },
              {
                title: "Version Control & Security",
                icon: <Shield className="w-6 h-6" />,
                skills: ["Git", "GitHub", "GitLab", "HashiCorp Vault", "CyberArk", "SonarQube", "Fortify"],
              },
              {
                title: "Monitoring & Logging",
                icon: <Monitor className="w-6 h-6" />,
                skills: ["Prometheus", "Grafana", "ELK Stack", "Elasticsearch", "Logstash", "Kibana"],
              },
              {
                title: "Database & Storage",
                icon: <Database className="w-6 h-6" />,
                skills: ["Azure Blob Storage", "S3", "RDS", "ARM Templates", "CloudFormation"],
              },
            ].map((category, index) => (
              <div
                key={index}
          ...
          <div className="bg-black/30 backdrop-blur-sm border border-cyan-500/20 rounded-2xl p-8">
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-cyan-400 text-lg mb-2">WIPRO TECHNOLOGIES</p>
                <p className="text-gray-400 mb-4">Azure Migration Project | Nov 2022 - Present</p>
              </div>
            </div>
      ...
      <section id="achivements" className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            {[
              ...
              },
              {
                ...
                description:
                  "Designed seamless multi-environment application deployments with consistent configurations",
                icon: <Server className="w-8 h-8" />,
              },
              {
                title: "Automated CI/CD Pipeline",
                description: "Built fully automated deployment pipeline reducing deployment time by 40% across regions",
                icon: <GitBranch className="w-8 h-8" />,
              },
              {
                title: "Infrastructure as Code",
                description:
                  "Developed scalable Azure infrastructure using Terraform with fault-tolerant availability zones",
          ...
          <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 rounded-2xl p-8">
            <h3 className="text-2xl font-bold text-center mb-6 text-white">Rewards & Recognition</h3>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-center gap-4">
                <Trophy className="w-8 h-8 text-yellow-400" />
                <div>
                  <h4 className="text-lg font-semibold text-white">Extra Mile Award</h4>
                  <p className="text-gray-300">Wipro's recognition for surpassing project expectations</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                <Award className="w-8 h-8 text-cyan-400" />
                <div>
                  <h4 className="text-lg font-semibold text-white">Client Recognition</h4>
                  <p className="text-gray-300">Consistently delivering key milestones and exceeding expectations</p>
                </div>
              </div>
            </div>
          </div>
